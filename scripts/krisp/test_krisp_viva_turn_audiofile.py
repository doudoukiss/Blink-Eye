...
Requirements:
    pip install soundfile numpy blink-ai[krisp]
...
try:
    from blink.audio.krisp_instance import KRISP_SAMPLE_RATES
    from blink.audio.turn.krisp_viva_turn import KrispTurnParams, KrispVivaTurn
except ImportError as e:
    print(f"Error: Could not import Krisp VIVA turn analyzer: {e}")
    print("Make sure blink-ai is installed: pip install blink-ai[krisp]")
    sys.exit(1)
