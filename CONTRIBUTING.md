...
We encourage community-maintained integrations. Start by matching the existing
service patterns under `src/blink/services/`, keep provider credentials in
environment variables, add focused tests, and document any required extras in
`pyproject.toml`.

**Want to contribute to Blink core?**
We welcome contributions of all kinds! Your help is appreciated. Follow these steps to get involved:

1. **Fork this repository**: Start by forking the Blink repository to your GitHub account.

2. **Clone the repository**: Clone your forked repository to your local machine.
   ```bash
   git clone https://github.com/your-username/Blink
   ```
...
For day-to-day work on a MacBook, start with the lightweight local workflow instead of installing every optional integration:
...
That path uses Python `3.12` and the local Ollama model `qwen3.5:4b`. See [LOCAL_DEVELOPMENT.md](LOCAL_DEVELOPMENT.md) for the full workflow and optional extras.
...
3. Run `uv sync --python 3.12` to install the updated dependencies locally
...
reported to the community leaders responsible for enforcement through the repository maintainers and moderation channels for this project.
