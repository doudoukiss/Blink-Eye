...
from blink.frames.frames import LLMRunFrame, LLMSetToolsFrame
from blink.observers.loggers.transcription_log_observer import TranscriptionLogObserver
...
from blink.services.openai.realtime.events import (
    AudioConfiguration,
    AudioInput,
...
from blink.services.openai.realtime.llm import OpenAIRealtimeLLMService
