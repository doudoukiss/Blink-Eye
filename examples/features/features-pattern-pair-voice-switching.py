...
"""Pattern Pair Voice Switching Example with Blink.
...
from blink.processors.aggregators.llm_text_processor import LLMTextProcessor
...
from blink.utils.text.pattern_pair_aggregator import (
    MatchAction,
    PatternMatch,
