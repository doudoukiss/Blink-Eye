...
from blink.extensions.voicemail.voicemail_detector import VoicemailDetector
from blink.frames.frames import TTSSpeakFrame
...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    async def on_voicemail_detected(processor):
        ...
        # Push frames using the standard Blink pattern
