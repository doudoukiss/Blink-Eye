...
"""Daily transport implementation for Blink.
...
from blink.audio.vad.vad_analyzer import VADAnalyzer, VADParams
...
try:
    ...
    logger.error(
        "In order to use the Daily transport, you need to `pip install blink-ai[daily]`."
    )
