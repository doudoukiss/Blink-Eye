...
"""HeyGen implementation for Blink.
...
from blink.services.heygen.api_interactive_avatar import NewSessionRequest
from blink.services.heygen.api_liveavatar import LiveAvatarNewSessionRequest
from blink.services.heygen.client import HeyGenCallbacks, HeyGenClient, ServiceType
...
class HeyGenTransport(BaseTransport):
    ...
    When used, the Blink bot joins the same virtual room as the HeyGen Avatar and the user.
    ...
    def __init__(
        ...
        handling video calls between the Blink bot and HeyGen Avatar.
