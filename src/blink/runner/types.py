...
class DialinSettings(BaseModel):
    ...
    This model matches the structure sent by the legacy cloud runtime and Daily.co webhooks
...
class DailyDialinRequest(BaseModel):
    ...
    It matches the payload structure from the legacy cloud-compatible dial-in webhook handler.
