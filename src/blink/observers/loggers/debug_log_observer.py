...
class DebugLogObserver(BaseObserver):
    ...
    Examples:
        ...
        Log specific frame types from any source/destination::
            ...
            from blink.frames.frames import LLMTextFrame, TranscriptionFrame
            observers=[
        ...
        Log frames with specific source/destination filters::
            ...
            from blink.frames.frames import InterruptionFrame, UserStartedSpeakingFrame, LLMTextFrame
