...
"""Metrics logging observer for Blink.
...
from blink.frames.frames import MetricsFrame
...
class MetricsLogObserver(BaseObserver):
    ...
    Examples:
        ...
        Log only LLM and TTS metrics::
            ...
            from blink.metrics.metrics import LLMUsageMetricsData, TTSUsageMetricsData
            observers = [
                MetricsLogObserver(
