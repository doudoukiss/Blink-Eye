...
"""Langchain integration processor for Blink."""
...
try:
    ...
    raise missing_dependency_error(feature="Langchain", extra="langchain", exc=e) from e


class LangchainProcessor(FrameProcessor):
    """Processor that integrates Langchain runnables with Blink's frame pipeline.
