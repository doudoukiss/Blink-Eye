"""Strands Agent integration for Blink.
...
class StrandsAgentsProcessor(FrameProcessor):
    """Processor that integrates Strands Agents with Blink's frame pipeline.
    ...
    async def _ainvoke(self, text: str):
        """Invoke the Strands agent with the provided text and stream results as Blink frames.
