...
from blink.processors.frameworks.rtvi.frames import RTVIClientMessageFrame
from blink.processors.frameworks.rtvi.observer import RTVIObserver, RTVIObserverParams
...
class RTVIProcessor(FrameProcessor):
    ...
    async def set_bot_ready(self, about: Mapping[str, Any] = None):
        ...
        Args:
            about: Optional information about the bot to include in the ready message.
                   If left as None, the Blink library and version will be used.
        """
    ...
    async def _send_bot_ready(self, about: Mapping[str, Any] = None):
        ...
        if not about:
            about = {
                "library": PROJECT_IDENTITY.distribution_name,
                "library_version": f"{blink_version()}",
            }
