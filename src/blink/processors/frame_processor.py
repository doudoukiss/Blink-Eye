...
"""Frame processing pipeline infrastructure for Blink.
...
from blink.metrics.metrics import LLMTokenUsage, MetricsData
from blink.observers.base_observer import BaseObserver, FrameProcessed, FramePushed
from blink.processors.metrics.frame_processor_metrics import FrameProcessorMetrics
...
class FrameProcessor(BaseObject):
    ...
    Frame processors are the building blocks of Blink pipelines, they can be
