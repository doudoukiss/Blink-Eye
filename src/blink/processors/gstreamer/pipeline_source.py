...
"""GStreamer pipeline source integration for Blink."""
...
try:
    ...
    logger.error(
        "In order to use GStreamer, you need to `pip install blink-ai[gstreamer]`. Also, you need to install GStreamer in your system."
    )
