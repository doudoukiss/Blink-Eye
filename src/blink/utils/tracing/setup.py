...
"""Core OpenTelemetry tracing utilities and setup for Blink.

This module provides functions to check availability and configure OpenTelemetry
tracing for Blink applications. It handles the optional nature of OpenTelemetry
