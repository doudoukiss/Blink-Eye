...
"""Turn trace observer for OpenTelemetry tracing in Blink.
...
from blink.frames.frames import StartFrame
...
class TurnTraceObserver(BaseObserver):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._tracer = trace.get_tracer("blink.turn") if is_tracing_available() else None
