...
and async cleanup for all Blink components.
"""
...
class BaseObject(ABC):
    """Abstract base class providing common functionality for Blink objects.

    Provides unique identification, naming, event handling capabilities,
    and async lifecycle management for all Blink components. All major
