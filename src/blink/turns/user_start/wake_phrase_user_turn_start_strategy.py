...
from blink.turns.user_start.base_user_turn_start_strategy import BaseUserTurnStartStrategy
...
class WakePhraseUserTurnStartStrategy(BaseUserTurnStartStrategy):
    ...
    def _check_wake_phrase(self, text: str) -> bool:
        ...
        "Hey, Blink!" still matches the phrase "hey blink".
