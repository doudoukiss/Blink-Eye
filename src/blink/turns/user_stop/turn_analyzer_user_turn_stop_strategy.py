...
from blink.audio.turn.base_turn_analyzer import BaseTurnAnalyzer, EndOfTurnState
from blink.audio.vad.vad_analyzer import VAD_STOP_SECS
...
from blink.turns.user_stop.base_user_turn_stop_strategy import BaseUserTurnStopStrategy
        ...
        if not self._stop_secs_warned:
            if self._stop_secs != VAD_STOP_SECS:
                ...
                logger.warning(
                    ...
                    f"https://github.com/blink-ai/stt-benchmark with your settings "
