...
"""Inworld Realtime LLM adapter for Blink.

Converts Blink's tool schemas and context into the format required by
...
from blink.processors.aggregators.llm_context import LLMContext, LLMContextMessage
from blink.services.inworld.realtime import events
...
class InworldRealtimeLLMAdapter(BaseLLMAdapter):
    ...
    Converts Blink's universal context and tool schemas into the specific
