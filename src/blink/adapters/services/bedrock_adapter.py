...
"""AWS Bedrock LLM adapter for Blink."""
...
class AWSBedrockLLMAdapter(BaseLLMAdapter[AWSBedrockLLMInvocationParams]):
    """Adapter for AWS Bedrock LLM integration with Blink.

    Provides conversion utilities for transforming Blink function schemas
