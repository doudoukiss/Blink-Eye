...
"""Vonage Audio Connector WebSocket serializer for Blink."""
...
class VonageFrameSerializer(FrameSerializer):
    ...
    This serializer converts between Blink frames and the Vonage Audio Connector
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a Blink frame to Vonage WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Vonage WebSocket data to Blink frames.

        Handles conversion of Vonage events to appropriate Blink frames.
        ...
        Returns:
            A Blink frame corresponding to the Vonage event, or None if unhandled.
        """
