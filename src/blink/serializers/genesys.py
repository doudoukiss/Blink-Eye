"""Genesys AudioHook Serializer for Blink.

This module provides a serializer for integrating Blink pipelines with
...
from blink.audio.resamplers.soxr_stream_resampler import SOXRStreamAudioResampler
from blink.audio.utils import pcm_to_ulaw, ulaw_to_pcm
...
from blink.serializers.base_serializer import FrameSerializer
...
class GenesysAudioHookSerializer(FrameSerializer):
    ...
    This serializer handles converting between Blink frames and Genesys
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Use Blink's official resampler if needed (SOXR)
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a Blink frame to Genesys AudioHook format.
        ...
        Args:
            frame: The Blink frame to serialize.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Genesys AudioHook data to Blink frames.
        ...
        Returns:
            A Blink frame to process, or None if handled internally.
        """
        # Binary data = audio
