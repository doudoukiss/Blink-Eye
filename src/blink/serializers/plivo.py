...
class PlivoFrameSerializer(FrameSerializer):
    ...
    This serializer handles converting between Blink frames and Plivo's WebSocket
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a Blink frame to Plivo WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Plivo WebSocket data to Blink frames.

        Handles conversion of Plivo media events to appropriate Blink frames.

        Args:
            data: The raw WebSocket data from Plivo.

        Returns:
            A Blink frame corresponding to the Plivo event, or None if unhandled.
        """
        try:
