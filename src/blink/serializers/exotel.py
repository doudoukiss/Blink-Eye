...
"""Exotel Media Streams serializer for Blink."""
...
class ExotelFrameSerializer(FrameSerializer):
    ...
    This serializer handles converting between Blink frames and Exotel's WebSocket
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a Blink frame to Exotel WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Exotel WebSocket data to Blink frames.

        Handles conversion of Exotel media events to appropriate Blink frames.

        Args:
            data: The raw WebSocket data from Exotel.

        Returns:
            A Blink frame corresponding to the Exotel event, or None if unhandled.
        """
