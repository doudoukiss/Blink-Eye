...
"""Telnyx WebSocket frame serializer for Blink."""
...
class TelnyxFrameSerializer(FrameSerializer):
    ...
    This serializer handles converting between Blink frames and Telnyx's WebSocket
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a Blink frame to Telnyx WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Telnyx WebSocket data to Blink frames.

        Handles conversion of Telnyx media events to appropriate Blink frames,
        ...
        Returns:
            A Blink frame corresponding to the Telnyx event, or None if unhandled.
