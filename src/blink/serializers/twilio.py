...
"""Twilio Media Streams WebSocket protocol serializer for Blink."""
...
from blink.audio.utils import create_stream_resampler, pcm_to_ulaw, ulaw_to_pcm
...
class TwilioFrameSerializer(FrameSerializer):
    ...
    This serializer handles converting between Blink frames and Twilio's WebSocket
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a Blink frame to Twilio WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Twilio WebSocket data to Blink frames.

        Handles conversion of Twilio media events to appropriate Blink frames.

        Args:
            data: The raw WebSocket data from Twilio.

        Returns:
            A Blink frame corresponding to the Twilio event, or None if unhandled.
        """
