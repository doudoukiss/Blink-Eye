...
"""Protobuf frame serialization for Blink."""
...
import blink.frames.protobufs.frames_pb2 as frame_protos
...
class ProtobufFrameSerializer(FrameSerializer):
    """Serializer for converting Blink frames to/from Protocol Buffer format.
