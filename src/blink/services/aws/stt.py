...
from blink.services.aws.utils import build_event_message, decode_event, get_presigned_url
from blink.services.settings import STTSettings
from blink.services.stt_latency import AWS_TRANSCRIBE_TTFS_P99
...
try:
    ...
    logger.error("In order to use AWS services, you need to `pip install blink-ai[aws]`.")
