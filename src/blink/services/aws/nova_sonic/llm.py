...
"""AWS Nova Sonic LLM service implementation for Blink AI framework.
...
from blink.adapters.services.aws_nova_sonic_adapter import AWSNovaSonicLLMAdapter, Role
...
try:
    ...
    logger.error(
        "In order to use AWS services, you need to `pip install blink-ai[aws-nova-sonic]`."
    )
...
class AWSNovaSonicLLMService(LLMService):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        file_path = files("blink.services.aws.nova_sonic").joinpath("ready.wav")
    ...
    #
    # LLM communication: input events (Blink -> LLM)
    #
    ...
    #
    # LLM communication: output events (LLM -> Blink)
    #
