...
from blink.adapters.services.bedrock_adapter import (
...
try:
    ...
    logger.error(
        "In order to use AWS services, you need to `pip install blink-ai[aws]`. Also, remember to set `AWS_SECRET_ACCESS_KEY`, `AWS_ACCESS_KEY_ID`, and `AWS_REGION` environment variable."
    )
