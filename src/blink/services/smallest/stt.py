...
from blink.services.stt_latency import SMALLEST_TTFS_P99
...
try:
    ...
    logger.error("In order to use Smallest, you need to `pip install blink-ai[smallest]`.")
...
class SmallestSTTService(WebsocketSTTService):
    ...
    Uses Blink's VAD to detect when the user stops speaking and sends
