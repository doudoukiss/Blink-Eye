...
from blink.services.stt_latency import NVIDIA_TTFS_P99
from blink.services.stt_service import SegmentedSTTService, STTService
...
try:
    ...
    logger.error("In order to use NVIDIA Riva STT, you need to `pip install blink-ai[nvidia]`.")
...
class NvidiaSegmentedSTTService(SegmentedSTTService):
    ...
    def language_to_service_language(self, language: Language) -> Optional[str]:
        """Convert Blink Language enum to NVIDIA Riva's language code.
