...
from blink.services.stt_latency import ELEVENLABS_REALTIME_TTFS_P99, ELEVENLABS_TTFS_P99
from blink.services.stt_service import SegmentedSTTService, WebsocketSTTService
...
try:
    ...
    logger.error(
        "In order to use ElevenLabs Realtime STT, you need to `pip install blink-ai[elevenlabs]`."
    )
...
class ElevenLabsRealtimeSTTService(WebsocketSTTService):
    ...
    By default, uses manual commit strategy where Blink's VAD controls when to
    ...
    class InputParams(BaseModel):
        ...
        Parameters:
            ...
            commit_strategy: How to segment speech - manual (Blink VAD) or vad (ElevenLabs VAD).
            vad_silence_threshold_secs: Seconds of silence before VAD commits (0.3-3.0).
        ...
        **kwargs,
        ...
        Args:
            ...
            commit_strategy: How to segment speech — ``CommitStrategy.MANUAL``
                (Blink VAD) or ``CommitStrategy.VAD`` (ElevenLabs VAD).
