...
from blink.services.heygen.api_interactive_avatar import HeyGenApi, NewSessionRequest
from blink.services.heygen.api_liveavatar import (
    LiveAvatarApi,
    LiveAvatarNewSessionRequest,
)
from blink.services.heygen.base_api import StandardSessionResponse
...
try:
    ...
    logger.error("In order to use HeyGen, you need to `pip install blink-ai[heygen]`.")
...
class HeyGenClient:
    ...
    def __init__(
        ...
        *,
        ...
        # regardless of whether the Blink agent remains present in the room.
