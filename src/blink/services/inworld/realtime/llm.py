...
try:
    ...
    logger.error("In order to use Inworld Realtime, you need to `pip install blink-ai[inworld]`.")
...
class InworldRealtimeLLMService(LLMService):
    ...
    **replaces** all defaults, so provide a complete config)::
        ...
        from blink.services.inworld.realtime.events import *
    ...
    async def _connect(self):
        ...
        try:
            ...
            session_key = f"blink-realtime-{int(time.time() * 1000)}"
    ...
    async def _send_session_update(self):
        ...
        settings.provider_data = {"metadata": {"sdk": "blink-realtime"}}
