...
from blink.transports.tavus.transport import TavusCallbacks, TavusParams, TavusTransportClient
...
class TavusVideoService(AIService):
    ...
    are routed through Blink's media pipeline.

    In use cases with DailyTransport, this creates two distinct virtual rooms:

    - Tavus room: Contains the Tavus Avatar and the Blink Bot
    - User room: Contains the Blink Bot and the user
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            persona_id: ID of the Tavus persona. Defaults to "blink-stream" for Blink TTS voice.
