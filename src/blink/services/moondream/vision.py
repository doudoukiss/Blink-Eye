...
from blink.services.settings import VisionSettings
from blink.services.vision_service import VisionService
...
try:
    ...
    logger.error("In order to use Moondream, you need to `pip install blink-ai[moondream]`.")
