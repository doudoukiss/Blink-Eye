...
from blink.frames.frames import TranscriptionFrame
...
def extract_whisper_probability(frame: TranscriptionFrame) -> Optional[float]:
    ...
    Example::
        ...
        from blink.services.groq.stt import GroqSTTService
        from blink.services.whisper.utils import extract_whisper_probability
...
def extract_openai_gpt4o_probability(frame: TranscriptionFrame) -> Optional[float]:
    ...
    Example::
        ...
        from blink.services.openai.stt import OpenAISTTService
        from blink.services.whisper.utils import extract_openai_gpt4o_probability
...
def extract_deepgram_probability(frame: TranscriptionFrame) -> Optional[float]:
    ...
    Example::
        ...
        from blink.services.whisper.utils import extract_deepgram_probability
