...
from blink.services.tts_service import TTSService, WebsocketTTSService
...
try:
    ...
    logger.error(
        "In order to use DeepgramWebsocketTTSService, you need to `pip install blink-ai[deepgram]`."
    )
