...
"""Google Cloud Speech-to-Text V2 service implementation for Blink.
...
from blink.services.stt_latency import GOOGLE_TTFS_P99
...
try:
    ...
    logger.error(
        "In order to use Google AI, you need to `pip install blink-ai[google]`. Also, set `GOOGLE_APPLICATION_CREDENTIALS` environment variable."
    )
...
class GoogleSTTService(STTService):
    ...
    async def _update_settings(self, delta: Settings) -> dict[str, Any]:
        ...
        """
        from blink.services.settings import is_given
