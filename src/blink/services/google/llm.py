...
"""Google Gemini integration for Blink.

This module provides Google Gemini integration for the Blink framework,
...
from blink.adapters.services.gemini_adapter import GeminiLLMAdapter, GeminiLLMInvocationParams
...
from blink.services.google.frames import LLMSearchResponseFrame
...
from blink.utils.dependencies import missing_dependency_error
from blink.utils.tracing.service_decorators import traced_llm
...
try:
    ...
    raise missing_dependency_error(feature="Google AI", extra="google", exc=e) from e
    ...
    class InputParams(BaseModel):
        ...
        Parameters:
            ...
            thinking: Thinking configuration with thinking_budget, thinking_level, and include_thoughts.
                ...
                If this is not provided, Blink disables thinking for all
