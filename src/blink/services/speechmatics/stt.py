...
from blink.services.stt_latency import SPEECHMATICS_TTFS_P99
...
try:
    ...
    logger.error(
        "In order to use Speechmatics, you need to `pip install blink-ai[speechmatics]`."
    )
...
class TurnDetectionMode(str, Enum):
    ...
    How the STT engine handles the endpointing of speech. If using Blink's built-in endpointing,
