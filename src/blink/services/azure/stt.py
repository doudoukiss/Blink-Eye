...
"""Azure Speech-to-Text service implementation for Blink.
...
from blink.services.azure.common import language_to_azure_language
from blink.services.settings import STTSettings
from blink.services.stt_latency import AZURE_TTFS_P99
...
try:
    ...
    logger.error("In order to use Azure, you need to `pip install blink-ai[azure]`.")
