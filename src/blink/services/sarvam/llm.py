...
from blink.services.openai.base_llm import OpenAILLMSettings
...
from blink.services.settings import _NotGiven, is_given
...
class SarvamLLMService(OpenAILLMService):
    ...
    def create_client(
        ...
        **kwargs,
        ...
        # sdk_headers() carries Blink User-Agent and should override caller-provided value.
