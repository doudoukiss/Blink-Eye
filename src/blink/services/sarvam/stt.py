...
from blink.services.sarvam._sdk import sdk_headers
...
from blink.services.stt_latency import SARVAM_TTFS_P99
from blink.services.stt_service import STTService
from blink.transcriptions.language import Language, resolve_language
...
try:
    ...
    logger.error("In order to use Sarvam, you need to `pip install blink-ai[sarvam]`.")
...
def language_to_sarvam_language(language: Language) -> str:
    ...
    """
    # Mapping of Blink Language enum to Sarvam language codes
    LANGUAGE_MAP = {
...
class SarvamSTTService(STTService):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Pass Blink SDK headers directly at client construction time so they are
    ...
    def language_to_service_language(self, language: Language) -> str:
        """Convert Blink Language enum to Sarvam's language code.
    ...
    async def process_frame(self, frame: Frame, direction: FrameDirection):
        ...
        Handles VAD frames for TTFB tracking when using Blink's VAD
    ...
    async def _connect(self):
        ...
        try:
            ...
            # Enable flush signal when using Blink's VAD (not Sarvam's) so that
    ...
    def _map_language_code_to_enum(self, language_code: str) -> Language:
        """Map Sarvam language code to Blink Language enum."""
        mapping = {
