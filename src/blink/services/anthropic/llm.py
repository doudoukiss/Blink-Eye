...
"""Anthropic AI service integration for Blink.
...
from blink.adapters.services.anthropic_adapter import (
    AnthropicLLMAdapter,
...
from blink.services.settings import NOT_GIVEN as _NOT_GIVEN
from blink.services.settings import LLMSettings, _NotGiven, is_given
...
try:
    ...
    raise missing_dependency_error(feature="Anthropic", extra="anthropic", exc=e) from e
