...
from blink.services.gladia.config import (
    GladiaInputParams,
    LanguageConfig,
    MessagesConfig,
    PreProcessingConfig,
...
from blink.services.stt_latency import GLADIA_TTFS_P99
...
try:
    ...
    logger.error("In order to use Gladia, you need to `pip install blink-ai[gladia]`.")
...
class GladiaSTTService(WebsocketSTTService):
    ...
    def language_to_service_language(self, language: Language) -> Optional[str]:
        """Convert Blink Language enum to Gladia's language code.
    ...
    def _prepare_settings(self) -> dict[str, Any]:
        ...
        settings["custom_metadata"]["blink"] = blink_version()
