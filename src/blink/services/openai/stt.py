...
from blink.services.stt_latency import OPENAI_REALTIME_TTFS_P99, OPENAI_TTFS_P99
from blink.services.stt_service import WebsocketSTTService
from blink.services.whisper.base_stt import (
        ...
        **kwargs,
        ...
        if websocket_connect is None:
            raise ImportError(
                ...
                "Install it with: pip install blink-ai[openai]"
            )
