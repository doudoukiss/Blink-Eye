...
from blink.adapters.services.open_ai_realtime_adapter import (
...
from blink.utils.tracing.service_decorators import traced_openai_realtime, traced_stt
...
try:
    ...
    logger.error("In order to use OpenAI, you need to `pip install blink-ai[openai]`.")
