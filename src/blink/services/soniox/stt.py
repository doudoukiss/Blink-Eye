...
from blink.services.stt_latency import SONIOX_TTFS_P99
...
try:
    ...
    logger.error("In order to use Soniox, you need to `pip install blink-ai[soniox]`.")
...
def language_to_soniox_language(language: Language) -> str:
    """Convert a Blink Language to a Soniox language code.
