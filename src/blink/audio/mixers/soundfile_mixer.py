...
from blink.frames.frames import MixerControlFrame, MixerEnableFrame, MixerUpdateSettingsFrame
...
try:
    ...
    logger.error(
        "In order to use the soundfile mixer, you need to `pip install blink-ai[soundfile]`."
    )
