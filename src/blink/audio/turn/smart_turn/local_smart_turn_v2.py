...
from blink.audio.turn.smart_turn.base_smart_turn import BaseSmartTurn
...
try:
    ...
    logger.error(
        "In order to use LocalSmartTurnAnalyzerV2, you need to `pip install blink-ai[local-smart-turn]`."
    )
...
class LocalSmartTurnAnalyzerV2(BaseSmartTurn):
    ...
    def __init__(self, *, smart_turn_model_path: str, **kwargs):
        ...
        if not smart_turn_model_path:
            ...
            smart_turn_model_path = "blink-ai/smart-turn-v2"
