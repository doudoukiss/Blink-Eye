...
"""ai-coustics AIC SDK audio filter for Blink.
...
the Koala filter and integrates with Blink's input transport pipeline.
...
from blink.audio.filters.base_audio_filter import BaseAudioFilter
from blink.audio.vad.aic_vad import AICVADAnalyzer
from blink.frames.frames import FilterControlFrame, FilterEnableFrame
...
class AICFilter(BaseAudioFilter):
    ...
    def __init__(
        ...
        *,
        ...
        """
        # Set the vendor SDK ID used for telemetry attribution.
        set_sdk_id(6)
        ...
        self._model_download_dir = model_download_dir or cache_dir("aic-models")
