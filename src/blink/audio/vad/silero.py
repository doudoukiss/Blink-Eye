...
"""Silero Voice Activity Detection (VAD) implementation for Blink.
...
try:
    ...
    logger.error("In order to use Silero VAD, you need to `pip install blink-ai`.")
...
class SileroVADAnalyzer(VADAnalyzer):
    ...
    def __init__(self, *, sample_rate: Optional[int] = None, params: Optional[VADParams] = None):
        ...
        model_file_path = str(Path(__file__).resolve().with_name("data").joinpath(model_name))
