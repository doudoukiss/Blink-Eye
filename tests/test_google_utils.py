...
class TestGoogleUtils(unittest.TestCase):
    def test_update_google_client_http_options_none(self):
        ...
        self.assertEqual(options, {"headers": {"x-goog-api-client": f"blink/{MOCKED_VERSION}"}})
    ...
    def test_update_google_client_http_options_object(self):
        ...
        self.assertEqual(
            updated_options.headers, {"x-goog-api-client": f"blink/{MOCKED_VERSION}"}
        )
    ...
    def test_update_google_client_http_options_object_existing_headers(self):
        ...
        self.assertEqual(updated_options.headers["x-goog-api-client"], f"blink/{MOCKED_VERSION}")
