...
import blink.services
from blink.services.ai_service import AIService
from blink.services.settings import ServiceSettings, is_given

# Modules that define abstract base service classes (not concrete services).
_BASE_MODULES = frozenset(
    {
        "blink.services.ai_service",
        "blink.services.llm_service",
        "blink.services.stt_service",
        "blink.services.tts_service",
        "blink.services.image_gen_service",
        "blink.services.vision_service",
    }
)
...
def _import_all_service_modules():
    """Import every module under blink.services (skipping missing deps)."""
    package = blink.services
