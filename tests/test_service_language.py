...
from blink.services.settings import STTSettings, TTSSettings
...
class TestTTSLanguageInit:
    ...
    def test_raw_string_unrecognized(self):
        ...
        with patch("blink.services.tts_service.logger") as mock_logger:
...
class TestSTTLanguageInit:
    ...
    def test_raw_string_unrecognized(self):
        """Unrecognized raw string logs a debug message and is passed through as-is."""
        with patch("blink.services.stt_service.logger") as mock_logger:
