...
# Mock package version check before importing Blink
...
# Mock krisp_audio module BEFORE any Blink imports
...
from blink.audio.filters.krisp_viva_filter import KrispVivaFilter
from blink.frames.frames import FilterEnableFrame
...
class TestKrispVivaFilter(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.sample_rates_patch = patch(
            "blink.audio.filters.krisp_viva_filter.krisp_audio", self.mock_krisp_audio
        )
        self.sample_rates_patch.start()

        # Patch KrispVivaSDKManager
        self.sdk_manager_patcher = patch(
            "blink.audio.filters.krisp_viva_filter.KrispVivaSDKManager"
        )
    ...
    async def test_start_with_supported_sample_rate(self):
        ...
        from blink.audio.krisp_instance import int_to_krisp_sample_rate
    ...
    async def test_int_to_sample_rate_conversion(self):
        ...
        from blink.audio.krisp_instance import KRISP_SAMPLE_RATES, int_to_krisp_sample_rate
