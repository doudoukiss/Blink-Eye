...
class TestDailyTransport(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_event_handler(self):
        from blink.transports.daily_transport import DailyTransport
    ...
    async def test_event_handler_async(self):
        from blink.services.daily_transport_service import DailyTransportService
    ...
    """
    @patch("blink.services.daily_transport_service.CallClient")
    @patch("blink.services.daily_transport_service.Daily")
