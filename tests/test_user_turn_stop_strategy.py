...
from blink.turns.user_stop import ExternalUserTurnStopStrategy, SpeechTimeoutUserTurnStopStrategy
...
class TestSpeechTimeoutStopSecsWarnings(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("blink.turns.user_stop.speech_timeout_user_turn_stop_strategy.logger")
