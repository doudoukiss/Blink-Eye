...
from blink.audio.vad.krisp_viva_vad import KrispVivaVadAnalyzer
from blink.audio.vad.vad_analyzer import VADParams
...
class TestKrispVivaVadAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.krisp_audio_patch = patch(
            "blink.audio.vad.krisp_viva_vad.krisp_audio", self.mock_krisp_audio
        )
        self.krisp_audio_patch.start()

        # Patch KrispVivaSDKManager
        self.sdk_manager_patcher = patch("blink.audio.vad.krisp_viva_vad.KrispVivaSDKManager")
