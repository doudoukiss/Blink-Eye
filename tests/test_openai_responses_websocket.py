...
class TestReceiveResponseEventsErrors:
    ...
    async def test_previous_response_not_found_raises(self):
        from blink.services.openai.responses.llm import _PreviousResponseNotFoundError
    ...
    async def test_connection_limit_reached_raises(self):
        from blink.services.openai.responses.llm import _ConnectionLimitReachedError
...
class TestConnectionLifecycle:
    ...
    async def test_reconnect_clears_state_and_reconnects(self):
        ...
        with patch(
            "blink.services.openai.responses.llm.websocket_connect",
