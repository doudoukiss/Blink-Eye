...
from tests._optional import OPTIONAL_PROVIDER, require_optional_modules

pytestmark = OPTIONAL_PROVIDER
require_optional_modules("anthropic", "google.genai")
...
from blink.adapters.services.anthropic_adapter import AnthropicLLMAdapter
from blink.adapters.services.aws_nova_sonic_adapter import AWSNovaSonicLLMAdapter
from blink.adapters.services.bedrock_adapter import AWSBedrockLLMAdapter
from blink.adapters.services.gemini_adapter import GeminiLLMAdapter
from blink.adapters.services.grok_realtime_adapter import GrokRealtimeLLMAdapter
from blink.adapters.services.open_ai_adapter import OpenAILLMAdapter
from blink.adapters.services.open_ai_realtime_adapter import OpenAIRealtimeLLMAdapter
from blink.adapters.services.open_ai_responses_adapter import OpenAIResponsesLLMAdapter
from blink.adapters.services.perplexity_adapter import PerplexityLLMAdapter
...
class TestOpenAIGetLLMInvocationParams(unittest.TestCase):
    ...
    def test_both_system_instruction_and_system_message_warns(self):
        ...
        with patch("blink.adapters.base_llm_adapter.logger") as mock_logger:
            params = self.adapter.get_llm_invocation_params(
...
class TestAnthropicGetLLMInvocationParams(unittest.TestCase):
    ...
    def test_initial_system_discarded_when_system_instruction_provided(self):
        ...
        with patch("blink.adapters.base_llm_adapter.logger"):
            params = self.adapter.get_llm_invocation_params(
                context,
                enable_prompt_caching=False,
