...
from blink.frames.frames import ErrorFrame
...
def _no_sleep():
    ...
    with patch("blink.services.websocket_service.asyncio.sleep", new_callable=AsyncMock):
        yield
...
async def test_stable_connection_resets_quick_failure_counter(service, report_error):
    ...
    with patch("blink.services.websocket_service.time") as mock_time:
