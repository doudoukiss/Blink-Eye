...
from blink.processors.frame_processor import (
    FrameDirection,
    FrameProcessor,
)
...
class TestFrameProcessor(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_broadcast_interruption(self):
        ...
        frames_to_send = [
            TextFrame(text="Hello from Blink!"),
    ...
    async def test_interruptible_frames(self):
        ...
        frames_to_send = [
            TestInterruptibleFrame(text="Hello from Blink!"),
    ...
    async def test_uninterruptible_frames(self):
        ...
        frames_to_send = [
            TestUninterruptibleFrame(text="Hello from Blink!"),
            # Make sure we hit the DelayTestFrameProcessor first.
            SleepFrame(),
