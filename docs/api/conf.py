...
def import_core_modules():
    """Import core Blink modules for autodoc to discover."""
    core_modules = [
        "blink",
        "blink.frames",
        "blink.pipeline",
...
def setup(app):
    ...
    source_dir = str(project_root / "src" / "blink")
    ...
    excludes = [
        str(project_root / "src/blink/examples"),
        str(project_root / "src/blink/tests"),
        "**/test_*.py",
        "**/tests/*.py",
    ]
