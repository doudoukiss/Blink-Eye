...
This directory contains the source files for auto-generating Blink's API reference documentation.
...
3. Verify the module is importable: `uv run python -c "import blink.module.name"`
